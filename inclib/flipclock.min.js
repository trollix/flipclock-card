(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.FlipClock = factory());
  ...
  var FaceValue = /*#__PURE__*/function (_Component) {
    _inherits(FaceValue, _Component);
    var _super = _createSuper(FaceValue);
    /**
   ...
   * @memberof Languages.Catalan
   */
  var aliases$s = ['ca', 'ca-es', 'catalan'];
   ...
   * @memberof Languages.Czech
   */
  var aliases$r = ['cs', 'cs-cz', 'cz', 'cz-cs', 'czech'];
   ...
   * @memberof Languages.English
   */
  var aliases$o = ['en', 'en-us', 'english'];
   ...
   * @memberof Languages.Spanish
   */
  var aliases$n = ['es', 'es-es', 'spanish'];
   ...
   * @memberof Languages.Persian
   */
  var aliases$m = ['fa', 'fa-ir', 'persian'];
   ...
   * @memberof Languages.Finnish
   */
  var aliases$l = ['fi', 'fi-fi', 'finnish'];
   ...
   * @memberof Languages.Hungarian
   */
  var aliases$i = ['hu', 'hu-hu', 'hungarian'];
   ...
   * @memberof Languages.Japanese
   */
  var aliases$g = ['jp', 'ja-jp', 'japanese'];
   ...
   * @memberof Languages.Latvian
   */
  var aliases$e = ['lv', 'lv-lv', 'latvian'];
   ...
   * @memberof Languages.Norwegian
   */
  var aliases$c = ['no', 'nb', 'no-nb', 'norwegian'];
   ...
   * @memberof Languages.Portuguese
   */
  var aliases$a = ['pt', 'pt-br', 'portuguese'];
   ...
   * @memberof Languages.Russian
   */
  var aliases$8 = ['ru', 'ru-ru', 'russian'];
   ...
   * @memberof Languages.Swedish
   */
  var aliases$6 = ['sv', 'sv-se', 'swedish'];
   ...
   * @memberof Languages.Turkish
   */
  var aliases$4 = ['tr', 'tr-tr', 'turkish'];
   ...
   * @memberof Languages.Ukrainian
   */
  var aliases$3 = ['ua', 'ua-ua', 'ukraine'];
   ...
   * @memberof Languages.Vietnamese
   */
  var aliases$2 = ['vn', 'vn-vn', 'vietnamese'];
   ...
   * @memberof Languages.Chinese
   */
  var aliases$1 = ['zh', 'zh-cn', 'chinese'];
  ...
  var DomComponent = /*#__PURE__*/function (_Component) {
    _inherits(DomComponent, _Component);
    var _super = _createSuper(DomComponent);
    /**
   ...
   * @param {(object|undefined)} [attributes] - The instance attributes.
   */
  var Divider$1 = /*#__PURE__*/function (_DomComponent) {
  ...
  var ListItem$1 = /*#__PURE__*/function (_DomComponent) {
  ...
  var List$1 = /*#__PURE__*/function (_DomComponent) {
    ...
    _createClass(List, [{
      ...
      value: function createListItem(value, attributes) {
        var item = new ListItem$1(value, Object.assign({
          theme: this.theme,
  ...
  var Group$1 = /*#__PURE__*/function (_DomComponent) {
  ...
  var Label$1 = /*#__PURE__*/function (_DomComponent) {
   ...
   * @memberof Faces
   */
  var Counter = /*#__PURE__*/function (_Face) {
   ...
   * @memberof Faces
   */
  var MinuteCounter$1 = /*#__PURE__*/function (_Face) {
    _inherits(MinuteCounter, _Face);
    var _super = _createSuper(MinuteCounter);
   ...
   * @memberof Faces
   */
  var HourCounter$1 = /*#__PURE__*/function (_MinuteCounter) {
    _inherits(HourCounter, _MinuteCounter);
    var _super = _createSuper(HourCounter);
   ...
   * @memberof Faces
   */
  var DayCounter$1 = /*#__PURE__*/function (_HourCounter) {
    _inherits(DayCounter, _HourCounter);
    var _super = _createSuper(DayCounter);
    function DayCounter() {
   ...
   * @memberof Faces
   */
  var TwentyFourHourClock$1 = /*#__PURE__*/function (_Face) {
    _inherits(TwentyFourHourClock, _Face);
    var _super = _createSuper(TwentyFourHourClock);
   ...
   * @memberof Faces
   */
  var TwelveHourClock$1 = /*#__PURE__*/function (_TwentyFourHourClock) {
    _inherits(TwelveHourClock, _TwentyFourHourClock);
    var _super = _createSuper(TwelveHourClock);
   ...
   * @memberof Faces
   */
  var WeekCounter$1 = /*#__PURE__*/function (_DayCounter) {
    _inherits(WeekCounter, _DayCounter);
    var _super = _createSuper(WeekCounter);
   ...
   * @memberof Faces
   */
  var YearCounter$1 = /*#__PURE__*/function (_WeekCounter) {
    _inherits(YearCounter, _WeekCounter);
    var _super = _createSuper(YearCounter);
  ...
  function FlipClock$1 (el, instance) {
  ...
  function Label (el, instance) {
    el.innerHTML = instance.t(instance.label);
  }

  function List (el, instance) {
  ...
  function DayCounter (el, instance) {
  ...
  function HourCounter (el, instance) {
    instance.createDivider().mount(el, el.childNodes[1]);
    if (instance.face.showSeconds) {
      instance.createDivider().mount(el, el.childNodes[3]);
    }
  ...
  function MinuteCounter (el, instance) {
    if (instance.face.showSeconds) {
      instance.createDivider().mount(el, el.childNodes[1]);
    }
    if (instance.face.showLabels) {
  ...
  function TwentyFourHourClock (el, instance) {
    instance.createDivider().mount(el, el.childNodes[1]);
    if (instance.face.showSeconds) {
      instance.createDivider().mount(el, el.childNodes[3]);
    }
  ...
  function TwelveHourClock (el, instance) {
  ...
  function WeekCounter (el, instance) {
    instance.createDivider().mount(el, el.childNodes[1]);
    instance.createDivider().mount(el, el.childNodes[3]);
    instance.createDivider().mount(el, el.childNodes[5]);
    if (instance.face.showSeconds) {
  ...
  function YearCounter (el, instance) {
    instance.createDivider().mount(el, el.childNodes[1]);
    instance.createDivider().mount(el, el.childNodes[3]);
    instance.createDivider().mount(el, el.childNodes[5]);
    instance.createDivider().mount(el, el.childNodes[7]);
  ...
  var FlipClock = /*#__PURE__*/function (_DomComponent) {
    ...
    _createClass(FlipClock, [{
      ...
      value: function render() {
        ...
        _get(_getPrototypeOf(FlipClock.prototype), "render", this).call(this);
      ...
      value: function createDivider(attributes) {
        return Divider$1.make(Object.assign({
          theme: this.theme,
          language: this.language
        }, attributes));
      }
      ...
      value: function createList(value, attributes) {
        return List$1.make(value, Object.assign({
          theme: this.theme,
          language: this.language
        }, attributes));
      }
      ...
      value: function createLabel(value, attributes) {
        return Label$1.make(value, Object.assign({
          theme: this.theme,
          language: this.language
        }, attributes));
      }
      ...
      value: function createGroup(items, attributes) {
        return Group$1.make(items, Object.assign({
          theme: this.theme,
          language: this.language
        }, attributes));
      }
